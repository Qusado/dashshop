...
export const Kpi_03 = ({form, setForm, kpi_active, setKPI_active, current_kpi_panel, setCurrent_kpi_panel}) => {
        ...
        <div className="position-relative">
            <div className="box_card3 container px-0">
                <div className="row justify-content-end">
                    <div className="col-3">
                        <div className="p_card3 modal_card" style={{paddingLeft:'21%', paddingRight:'0px'}}>
                            <div className="card">
